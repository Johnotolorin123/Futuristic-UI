...
function App() {
  ...
  const undo = useCallback(() => {
      ...
      setFuture(prev => [{ sessions, currentSessionIndex, focusedArtifactIndex }, ...prev]);
      setPast(newPast);
      
      setSessions(previous.sessions);
      setCurrentSessionIndex(previous.currentSessionIndex);
      setFocusedArtifactIndex(previous.focusedArtifactIndex);
  }, [past, sessions, currentSessionIndex, focusedArtifactIndex]);
  ...
  const redo = useCallback(() => {
      ...
      setPast(prev => [...prev, { sessions, currentSessionIndex, focusedArtifactIndex }]);
      setFuture(newFuture);
      
      setSessions(next.sessions);
      setCurrentSessionIndex(next.currentSessionIndex);
      setFocusedArtifactIndex(next.focusedArtifactIndex);
  }, [future, sessions, currentSessionIndex, focusedArtifactIndex]);
...
\`{ "name": "Persona Name", "html": "..." }\`
  ...
  const applyVariation = (html: string) => {
      ...
      recordHistory(); // Save before mutation
  ...
  const handleSendMessage = useCallback(async (manualPrompt?: string) => {
    ...
    recordHistory(); // Save before adding new session
...
Return ONLY RAW HTML. No markdown fences.
  ...
  }, [inputValue, isLoading, sessions, recordHistory]);
  ...
  }, [currentSessionIndex, sessions.length, focusedArtifactIndex, recordHistory]);
  ...
  }, [currentSessionIndex, focusedArtifactIndex, recordHistory]);

  const toggleFocus = useCallback((index: number | null) => {
    recordHistory();
        ...
        <div className="immersive-app">
            ...
            <div className={`action-bar ${focusedArtifactIndex !== null ? 'visible' : ''}`}>
                 ...
                 <div className="action-buttons">
                    <button onClick={() => toggleFocus(null)}>
                        <GridIcon /> Grid View
                    </button>
